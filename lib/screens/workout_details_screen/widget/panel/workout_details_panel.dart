...
import 'package:cross_fitness/screens/workout_details_screen/widget/panel/excercises_list.dart';
import 'package:cross_fitness/screens/workout_details_screen/widget/panel/workout_tag.dart';
...
class WorkoutDetailsPanel extends StatelessWidget {
  ...
  Widget _createRectangle() {
    return const Image(
      image: AssetImage(PathConstants.rectangle),
    );
  }
