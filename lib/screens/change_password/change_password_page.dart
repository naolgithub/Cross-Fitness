...
import 'package:cross_fitness/screens/change_password/bloc/change_password_bloc.dart';
...
class _ChangePasswordScreenState extends State {
  ...
  Widget _editAccountContent(BuildContext context) {
    ChangePasswordBloc bloc = BlocProvider.of(context);
                ...
                FitnessButton(
                  ...
                  onTap: () {
                    ...
                    if (!(isNewPassInvalid || isConfirmPassInvalid)) {
                      bloc.add(
                        ChangePassword(newPass: _newPassController.text),
                      );
                    }
                  },
                ),
