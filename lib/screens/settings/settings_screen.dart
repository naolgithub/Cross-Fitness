...
import 'package:cross_fitness/screens/reminder/page/reminder_page.dart';
import 'package:cross_fitness/screens/settings/bloc/settings_bloc.dart';
import 'package:cross_fitness/screens/sign_in/page/sign_in_page.dart';
  ...
  BlocProvider _buildContext(BuildContext context) {
    return BlocProvider(
      ...
      child: BlocConsumer<SettingsBloc, SettingsState>(
        buildWhen: (context, currState) => currState is SettingsInitial,
            ...
            children: [
              Stack(alignment: Alignment.topRight, children: [
                BlocBuilder(
                  ...
                  builder: (context, state) {
                    final photoURL = state is SettingsReloadImageState
                        ? state.photoURL
                        : null;
                    return Center(
                      child: photoURL == null
                          ? const CircleAvatar(
                              backgroundImage:
                                  AssetImage(PathConstants.profile),
                              radius: 60,
                            )
                          : CircleAvatar(
                              radius: 60,
